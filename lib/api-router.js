        ...
        const result = await callOpenAICompatible({
          ...
          messages: [
            { role: "system", content: assetType === "character"
              ? "Compress a character card into faithful JSON. Preserve all canon facts, relationships, current arc, and important notes. Do not invent or alter facts. Return only JSON with keys core, traits, relationships, arcState, notes."
              : "Compress a worldbook into faithful JSON. Preserve all canon rules, content, revealed facts, and current story state. Do not invent or alter facts. Return only JSON with keys title, category, rules, content, revealedFacts, storyState." },
