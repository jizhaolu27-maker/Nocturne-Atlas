...
function createMemoryTools({
  ...
  async function createStructuredMemoryRecord({
    ...
    if (
      ...
      typeof embedText === "function" &&
      typeof buildMemoryEmbeddingText === "function"
    ) {
      record.embedding = await embedText(buildMemoryEmbeddingText(record), embeddingOptions);
      record.embeddingModel = embeddingOptions.provider || "hash_v1";
