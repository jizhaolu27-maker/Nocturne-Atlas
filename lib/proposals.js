    ...
    try {
      ...
      return parsed.proposals
        ...
        .filter((item) => {
          ...
          return Boolean(relation.sourceId && relation.targetId && relation.sourceId !== relation.targetId && characterIds.has(relation.sourceId) && characterIds.has(relation.targetId));
        })
        .filter((item) => {
