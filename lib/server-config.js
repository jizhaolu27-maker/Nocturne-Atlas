...
function createServerConfigTools({
  ...
  function normalizeRetrievalMode(value, fallback = "lexical") {
  ...
  function normalizeAppConfig(config = {}) {
    const memoryRetrievalMode = normalizeRetrievalMode(config.memoryRetrievalMode, "lexical");
    ...
    const knowledgeRetrievalMode = hasExplicitKnowledgeRetrievalMode
      ? normalizeRetrievalMode(config.knowledgeRetrievalMode, "lexical")
